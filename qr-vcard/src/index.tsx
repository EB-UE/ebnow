...
import { QrVcardProps, QrVcard } from "./qr-vcard";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/qr-vcard.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <qr-vcard message="world!"></qr-vcard>
   */
  return class QrVcardBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): QrVcardProps {
      const attrs = this.parseAttributes<QrVcardProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<QrVcard {...this.props} />);
    }
