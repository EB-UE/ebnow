...
import { LunchlotterieHotdogProps, LunchlotterieHotdog } from "./lunchlotterie-hotdog";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/lunchlotterie-hotdog.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <lunchlotterie-hotdog message="world!"></lunchlotterie-hotdog>
   */
  return class LunchlotterieHotdogBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): LunchlotterieHotdogProps {
      const attrs = this.parseAttributes<LunchlotterieHotdogProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<LunchlotterieHotdog {...this.props} />);
    }
...
const blockDefinition: BlockDefinition = {
    name: "lunchlotterie-hotdog",
    factory: factory,
    attributes: widgetAttributes,
    blockLevel: 'block',
    configurationSchema: configurationSchema,
    uiSchema: uiSchema,
    label: 'Lunchlotterie Hotdog',
    iconUrl: icon
};
