...
import { WeihnachtspaeckchenaktionChristmastreeProps, WeihnachtspaeckchenaktionChristmastree } from "./weihnachtspaeckchenaktion-christmastree";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/weihnachtspaeckchenaktion-christmastree.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <weihnachtspaeckchenaktion-christmastree message="world!"></weihnachtspaeckchenaktion-christmastree>
   */
  return class WeihnachtspaeckchenaktionChristmastreeBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): WeihnachtspaeckchenaktionChristmastreeProps {
      const attrs = this.parseAttributes<WeihnachtspaeckchenaktionChristmastreeProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<WeihnachtspaeckchenaktionChristmastree {...this.props} />);
    }
...
const blockDefinition: BlockDefinition = {
    name: "weihnachtspaeckchenaktion-christmastree",
    factory: factory,
    attributes: widgetAttributes,
    blockLevel: 'block',
    configurationSchema: configurationSchema,
    uiSchema: uiSchema,
    label: 'Weihnachtspaeckchenaktion Christmastree',
    iconUrl: icon
};
