...
import { BirthdayPreviewProps, BirthdayPreview } from "./birthday-preview";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <birthday-preview message="world!"></birthday-preview>
   */
  return class BirthdayPreviewBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): BirthdayPreviewProps {
      const attrs = this.parseAttributes<BirthdayPreviewProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<BirthdayPreview {...this.props} />, container);
    }
...
const blockDefinition: BlockDefinition = {
    name: "birthday-preview",
    factory: factory,
    attributes: widgetAttributes,
    blockLevel: 'block',
    configurationSchema: configurationSchema,
    uiSchema: uiSchema,
    label: 'Birthday Preview'
};
