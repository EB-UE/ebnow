...
import { TemplateMinOneHyphenIsNeededProps, TemplateMinOneHyphenIsNeeded } from "./template-min-one-hyphen-is-needed";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <template-min-one-hyphen-is-needed message="world!"></template-min-one-hyphen-is-needed>
   */
  return class TemplateMinOneHyphenIsNeededBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): TemplateMinOneHyphenIsNeededProps {
      const attrs = this.parseAttributes<TemplateMinOneHyphenIsNeededProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<TemplateMinOneHyphenIsNeeded {...this.props} />, container);
    }
...
const blockDefinition: BlockDefinition = {
    name: "template-min-one-hyphen-is-needed",
    factory: factory,
    attributes: widgetAttributes,
    blockLevel: 'block',
    configurationSchema: configurationSchema,
    uiSchema: uiSchema,
    label: 'Template Min One Hyphen Is Needed'
};
